...
(deflayer arrowlayer
  esc    1      2      3      4      5      6      7      8      9      0      C--      C-=      C-\\    `
  C-tab  C-q    C-w    C-e    C-r    C-t    C-y    C-u    C-i    C-o    C-p    C-[    C-]    C-bspc
  lctl   C-a    C-s    C-d    C-f    C-g    left   down   up     right  C-;    C-'    C-ret
  @acs   C-z    C-x    C-c    C-v    C-b    C-n    C-m    C-,    C-.    C-/    C-rsft
         C-lmet C-lalt               spc                  ralt   rmet
)

(deflayer normal-shift
  esc     S-1    S-2    S-3    S-4    S-5    S-6    S-7    S-8    S-9    S-0    S--    S-=    S-\\    ~
  S-tab   S-q    S-w    S-e    S-r    S-t    S-y    S-u    S-i    S-o    S-p    S-[    S-]    del
  @acs    S-a    S-s    S-d    S-f    S-g    S-h    S-j    S-k    S-l    S-;    S-'    S-ret
  XX      S-z    S-x    S-c    S-v    S-b    S-n    S-m    S-,    S-.    S-/    XX
          S-lmet S-lalt               spc                  ralt   rmet
)

(deflayer after-ctrl-shift
  XX      1        2        3        4        5        6        7        8        9        0        C-S--        C-S-=        C-S-\\   `
  C-S-tab C-S-q    C-S-w    C-S-e    C-S-r    C-S-t    C-S-y    C-S-u    C-S-i    C-S-o    C-S-p    C-S-[    C-S-]    S-del
  ...
  XX      C-S-z    C-S-x    C-S-c    C-S-v    C-S-b    C-S-n    C-S-m    C-S-,    C-S-.    C-S-/    XX
          C-S-lmet C-S-lalt                 spc                          ralt     rmet
)
